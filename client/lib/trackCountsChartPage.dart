...
class TrackCountsChartPage extends StatefulWidget {
	createState() => _TrackCountsChartPageState();
}


class _TrackCountsChartPageState extends State<TrackCountsChartPage> {
	...
	Future<LinkedHashMap<String, int>> refresh() async {
		...
		return await server.getTrackPeriodCounts(startDate: startDate, endDate: endDate, period: period, limit: barCount);  //TODO Remove offset from this function as dates are now used instead
	}
