...
class TrackPlaysChartPage extends StatefulWidget {
	final Track track;

	TrackPlaysChartPage(this.track);
	createState() => _TrackPlaysChartPageState();
}


class _TrackPlaysChartPageState extends State<TrackPlaysChartPage> {
