...
class PlayChartWidget extends StatefulWidget {
	createState() => _PlayChartWidgetState();
}

class _PlayChartWidgetState extends State<PlayChartWidget> {
	...
	Future<LinkedHashMap<String, int>> refresh() async {
		...
		return await server.getPlayPeriodCounts(startDate: startDate, endDate: endDate, period: period, limit: barCount);  //TODO Remove offset from this function as dates are now used instead
	}
