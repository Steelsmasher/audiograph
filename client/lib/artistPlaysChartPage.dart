...
class ArtistPlaysChartPage extends StatefulWidget {
	final Artist artist;

	ArtistPlaysChartPage(this.artist);
	createState() => _ArtistPlaysChartPageState();
}


class _ArtistPlaysChartPageState extends State<ArtistPlaysChartPage> {
